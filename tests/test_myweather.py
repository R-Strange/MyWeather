from my_weather.src.my_weather import (
    read_creds,
    parse_user_cli_args,
    api_url_query_string_builder,
    print_weather_data,
)
import yaml
import argparse
...
class TestReadCreds:
    def mock_open_yaml(
        ...
        mocker,
        yaml_data="mock data",
        return_value={"open_weather_api_key": "12345"},
        side_effect=None,
    ):
    ...
    def assert_yaml_open_and_load_called(self, mock_open, mock_yaml_load):
        mock_open.assert_called_once_with(
            "/home/rstrange/Github/Portfolio/MyWeather/creds.yaml", "r"
        )
    ...
    def test_read_creds_success(self, mocker):
        ...
        assert (
            str(result) == "12345"
        ), "The API key read from the file does not match the expected value."
    ...
    def test_yaml_format_error(self, mocker):
        ...
        mock_open, mock_yaml_load = self.mock_open_yaml(
            mocker, side_effect=yaml.YAMLError
        )
...
class TestParseUserCliArgs:
    ...
    def test_parse_city_name_positional_argument(self, mocker):
        ...
        mocker.patch(
            ...
            return_value=argparse.Namespace(city=city_name),
        )
    ...
    def test_parse_imperial_flag_optional_argument(self, mocker):
        ...
        mocker.patch(
            "argparse.ArgumentParser.parse_args",
            return_value=argparse.Namespace(imperial=True),
        )
    ...
    def test_return_argparse_namespace_object(self, mocker):
        ...
        mocker.patch(
            "argparse.ArgumentParser.parse_args",
            return_value=argparse.Namespace(city=city_name, imperial=True),
        )
    ...
    def test_no_city_name_return_value(self, mocker):
        ...
        mocker.patch(
            "argparse.ArgumentParser.parse_args",
            return_value=argparse.Namespace(city=None),
        )
    ...
    def test_raise_error_invalid_city_name(self, mocker):
        ...
        mocker.patch(
            "argparse.ArgumentParser.parse_args",
            return_value=argparse.Namespace(city="1234"),
        )
...
class TestApiUrlQueryStringBuilder:
    ...
    def test_builds_url_query_string_with_imperial_units_when_imperial_true(self):
        ...
        assert (
            result
            == "https://api.openweathermap.org/data/2.5/weather?q=London&units=imperial&appid=1234567890abcdef1234567890abcdef"
        )
    ...
    def test_joins_multiple_word_cities_into_single_string_for_query_string(self):
        ...
        assert (
            result
            == "https://api.openweathermap.org/data/2.5/weather?q=New York&units=metric&appid=1234567890abcdef1234567890abcdef"
        )
    ...
    def test_does_not_contain_appid_if_open_weather_api_key_variable_is_none(self):
        ...
        # When
        query_string = api_url_query_string_builder(
            open_weather_api_key, city, imperial
        )  # type: ignore
